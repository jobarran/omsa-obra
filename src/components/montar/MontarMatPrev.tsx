...
export const MontarMatPrev = ({ data }: Props) => {
    ...
    return (
        <div id="material" className={`w-2/4 h-44 mr-1 bg-white border ${material && date && floor && possition ? 'border-gray-600' : 'border-gray-200'} text-gray-900 sm:text-sm rounded-lg p-4`}>
